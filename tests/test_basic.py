...
def test_group_commands_dict(runner):
    ...
    @click_hotoffthehamster.command()
    def sub():
        click_hotoffthehamster.echo("sub", nl=False)

    cli = click_hotoffthehamster.Group(commands={"other": sub})
...
def test_group_from_list(runner):
    ...
    cli = click_hotoffthehamster.Group(commands=[sub])
...
def test_string_option(runner, args, expect):
    @click_hotoffthehamster.command()
    @click_hotoffthehamster.option("--s", default="no value")
    def cli(s):
        click_hotoffthehamster.echo(f"S:[{s}]")
...
def test_int_option(runner, args, expect):
    @click_hotoffthehamster.command()
    @click_hotoffthehamster.option("--i", default=42)
    def cli(i):
        click_hotoffthehamster.echo(f"I:[{i * 2}]")
...
def test_float_option(runner, args, expect):
    @click_hotoffthehamster.command()
    @click_hotoffthehamster.option("--f", default=42.0)
    def cli(f):
        click_hotoffthehamster.echo(f"F:[{f}]")
...
def test_boolean_switch(runner, default, args, expect):
    @click_hotoffthehamster.command()
    @click_hotoffthehamster.option("--on/--off", default=default)
    def cli(on):
        return on
...
def test_boolean_flag(runner, default, args, expect):
    @click_hotoffthehamster.command()
    @click_hotoffthehamster.option("--f", is_flag=True, default=default)
    def cli(f):
        return f
...
def test_boolean_conversion(runner, value, expect):
    @click_hotoffthehamster.command()
    @click_hotoffthehamster.option("--flag", type=bool)
    def cli(flag):
        click_hotoffthehamster.echo(flag, nl=False)
...
def test_path_option(runner):
    ...
    def showtype(f):
        click_hotoffthehamster.echo(f"is_file={os.path.isfile(f)}")
        click_hotoffthehamster.echo(f"is_dir={os.path.isdir(f)}")
    ...
    def exists(f):
        click_hotoffthehamster.echo(f"exists={os.path.exists(f)}")
