...
class Command:
    ...
    def __init__(
        ...
        help: str | t.Callable[[Context], str] | None = None,
    ...
    def get_user_help_text(self, ctx: Context) -> str:
        """Returns help text, which maybe generated by user callback."""
        try:
            # I.e., `if callable(self.help)`
            help_text = self.help(ctx)
        except TypeError:
    ...
    def format_help_text(self, ctx: Context, formatter: HelpFormatter) -> None:
        ...
        if self.help is not None:
            ...
            text = inspect.cleandoc(help_text).partition("\f")[0]
        else:
            text = ""
